const center = [27.14493, -15.488839];
const pitch = 60;
const bearing = 0;
const zoom = 7.5;
...
const legendOptions = {
  ...
  ZMB_risk: {
    name: 'COMBINED FLOOD AND DROUGHT RISK SCORE',
    colors: ['#ffffff','#ffbfbf','#ff8080','#ff4040','#ff0000'],
    min: 0,
    max: 1,
    range: true,
  },
...
export {
  ...
  suitabilityStops, tooltipConfig, isoStops,riskStops,
};